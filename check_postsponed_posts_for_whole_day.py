...
def check_missed_posts_for_tomorrow(group_for_post_id, schedule_dict, token):
    missed_posts_time = vk_bot.check_postpones_posts_for_tomorrow(group_for_post_id, schedule_dict, token)
    if missed_posts_time:
...
if __name__ == "__main__":
    check_missed_posts_for_tomorrow(config.group_for_post_id,vk_bot.get_schedule(), vk_bot.token)
