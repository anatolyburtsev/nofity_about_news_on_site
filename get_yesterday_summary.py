...
if __name__ == "__main__":
    ...
    likes_for_yest, reposts_for_yest = vk_bot.get_all_posts_from_group_by_url("https://vk.com/x_community",
                                             vk_bot.processing_post_count_likes_and_repost,
                                             [likes, reposts],
                                             vk_bot.processing_post_stop_on_yesterdays_post,
                                             token)

    text = "Товарищи! Хорошо вчера поработали: " + str(likes_for_yest) + " лайков и " + str(reposts_for_yest) + " репостов!"
